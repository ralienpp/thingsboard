...
export default function addLocaleRussian(locales) {
    var ro_RO = {
        "access": {
            ...
            "unauthorized-access": "Acces interzis",
            "unauthorized-access-text": "Trebuie să vă autorizați pentru a primi acces la această resursă!",
            ...
            "refresh-token-expired": "Sesiune expirată",
        ...
        "action": {
            ...
            "search": "Caută",
            "assign": "Atribuie",
            "unassign": "Anulează atribuirea",
            "share": "Partajează",
            "make-private": "Blochează accesul public",
            "apply": "Aplică",
            "apply-changes": "Aplică modificările",
            "edit-mode": "Regim de editare",
            "enter-edit-mode": "Regim de editare",
            "decline-changes": "Anulează modificările",
            "close": "Închide",
            "back": "Înapoi",
            "run": "Lansează",
            "sign-in": "Intră",
            ...
            "share-via": "Partajează prin {{provider}}"
        },
        "aggregation": {
    ...
    angular.extend(locales, {'ro_RO': ro_RO});
}